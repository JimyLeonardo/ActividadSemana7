...
namespace Comercializadora.Controllers
{
    public class TipoUsuariosController : Controller
    {
        ...
        public TipoUsuariosController(ComercializadoraContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.TipoUsuarios != null ? 
                          ...
                          Problem("Entity set 'ComercializadoraContext.TipoUsuarios'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Fecha")] TipoUsuario tipoUsuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Fecha")] TipoUsuario tipoUsuario)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ComercializadoraContext.TipoUsuarios'  is null.");
            }
            var tipoUsuario = await _context.TipoUsuarios.FindAsync(id);
            if (tipoUsuario != null)
            {
